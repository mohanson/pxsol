...
class HashSet:
    ...
    def decode(self, reader: typing.BinaryIO) -> typing.List:
        return ArrayVariable(self.kype).decode(reader)

    def encode(self, data: typing.List) -> bytearray:
        return ArrayVariable(self.kype).encode(data)
...
class Option:
    ...
    def encode(self, data: typing.Optional[typing.Any]) -> bytearray:
        return bytearray([1]) + self.kype.encode(data) if data is not None else bytearray([0])
